											...
											<?php include 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-4 col-md-4">
													...
													<div class="form-group">
														...
														<select name="country" required class="form-control" data-live-search="true">
                                                           ...
                                                           $stmt = $conn->prepare("SELECT * FROM tbl_states ORDER BY id");
                                                           $stmt->execute();
                                                           $result = $stmt->fetchAll();
  
                                                           foreach($result as $row)
                                                           {
		                                                    ?> <option <?php if ($jobcountry == $row['state_name']) { print ' selected '; } ?> value="<?php echo $row['state_name']; ?>"><?php echo $row['state_name']; ?></option> <?php
												...
												<div class="col-xss-12 col-xs-6 col-sm-6 col-md-4">
													...
													<div class="form-group mb-20">
														...
														<select name="jobtype" required class="form-control" data-live-search="false" data-selected-text-format="count > 3" data-done-button="true" data-done-button-text="OK" data-none-selected-text="All">
															...
															<option <?php if ($jobtype == "Full-time") { print ' selected '; } ?> value="Full-time">Tiempo completo</option>
															<option <?php if ($jobtype == "Part-time") { print ' selected '; } ?> value="Part-time">Medio tiempo</option>
															<option <?php if ($jobtype == "Freelance") { print ' selected '; } ?> value="Freelance" >Pasantía / Práctica</option>
														</select>
													</div>
												...
												<div class="col-xss-12 col-xs-6 col-sm-6 col-md-4">
													...
													<div class="form-group mb-20">
														...
														<select name="experience" required class="form-control" data-live-search="false" data-selected-text-format="count > 3" data-done-button="true" data-done-button-text="OK" data-none-selected-text="All">
															...
															<option <?php if ($experience == "5 años") { print ' selected '; } ?> value="5 años">5 Años</option>
															<option <?php if ($experience == "Experto") { print ' selected '; } ?> value="Experto">Experto</option>
														</select>
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group ">
														...
														<textarea class="form-control " name="description" required placeholder="Enter description ..." style="height: 200px;"><?php echo "$jobdescription"; ?></textarea>
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group ">
														...
														<textarea name="responsiblities" required class="form-control" placeholder="Enter responsiblities..." style="height: 200px;"><?php echo "$jobrespo"; ?></textarea>
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group">
														...
														<textarea name="requirements" required class="form-control" placeholder="Enter requirements..." style="height: 200px;"><?php echo "$jobreq"; ?></textarea>
													</div>
