								...
								<div class="admin-content-wrapper">
									...
									<?php
                                        ...
                                        foreach($result as $row)
                                        {
										   ...
										   if ($type == "Freelance") {
											 $sta = '<span class="label label-success">Práctica / Pasantía</span>';
										   ...
										   ?>
											...
											<p class="date text-muted font12 font-italic">Vencimiento - <?php echo "$deadline"; ?></p>
											</div>
											...
											<a target="_blank" href="view-applicants.php?jobid=<?php echo $row['job_id']; ?>">Aplicantes</a>
											<a href="edit-job.php?jobid=<?php echo $row['job_id']; ?>">Editar</a>
											<a onclick = "return confirm('¿Está seguro que desea eliminar este empleo?')" href="app/drop-job.php?id=<?php echo $row['job_id']; ?>">Eliminar</a>
											</div>
											</div>
