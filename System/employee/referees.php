	...
	<?php include_once('secondary-header.php'); ?>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<a href="app/drop-ref.php?id=<?php echo $row['id']; ?>" onclick = "return confirm('¿Está seguro que desea eliminar esta referencia?')" class="btn btn-primary btn-sm btn-inverse">Eliminar</a>
								    ...
								    <label style="text-align: left">Nombre de Referente<b style="color: red;">*</b></label>
							        ...
							        <div class="form-group"> 
								    <label style="text-align: left">Correo Electrónico<b style="color: red;">*</b></label>
							        ...
							        <div class="form-group"> 
								    <label style="text-align: left">Puesto<b style="color: red;">*</b> </label>
							        ...
							        <div class="form-group"> 
								    <label style="text-align: left">Teléfono<b style="color: red;">*</b></label>
								...
								?>
							        ...
							        <div class="form-group"> 
								    <label>Nombre Referente<b style="color: red;">*</b></label>
								    <input class="form-control" placeholder="Ingrese nombre del referente" type="text" name="name" required> 
							        </div>
								    ...
								    <input class="form-control" placeholder="Ingrese correo" type="email" name="email" required> 
							        </div>
								    ...
								    <input class="form-control" placeholder="Ingrese puesto" type="text" name="title" required> 
							        </div>
								    ...
								    <input class="form-control" placeholder="Ingrese número de teléfono" type="text" name="phone" required> 
							        </div>
