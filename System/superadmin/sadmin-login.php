...
<head>
	...
	<title>Iniciar Sesión Súper-Administrador</title>
			    ...
			    <div class="row">
			      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
			        <div class="card card-signin my-5">
			          <div class="card-body">
			            <h5 class="card-title text-center">Iniciar sesión Súper-Administrador</h5>
									<?php
							include '../constants/check_reply.php';	
						?>
			           
			            <form class="form-signin" name="frm" action="app/auth-admin.php" method="POST" autocomplete="off">
			              ...
			              <div class="custom-control custom-checkbox mb-3">
			                <a href="https://www.claves.una.ac.cr/">¿Olvidó la contraseña?</a> 
			              </div>	
			              <div class="custom-control custom-checkbox mb-3">
