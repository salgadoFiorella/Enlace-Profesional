						...
						<div class="col-md-10 col-md-offset-1">
							...
							<div class="row">
								...
								try {
									...
									$stmt = $conn->prepare("SELECT * FROM tbl_alerts where code=".$cod);
									$stmt->execute();
									...
									foreach($result as $row)
									{
										if($row['type'] == "success"){
										echo '
											<div class="alert alert-success" role="alert">'.$row['description'].'
											</div>';
										}else{
											echo '<div class="alert alert-danger" role="alert">'.$row['description'].'</div>';
										}
									}
